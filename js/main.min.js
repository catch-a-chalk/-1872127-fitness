...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,s){"use strict";s.r(t);var n=s(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),a=s(/*! ./modules/modals/init-modals */"./js/modules/modals/init-modals.js"),i=s(/*! ./modules/init-video */"./js/modules/init-video.js"),r=s(/*! ./modules/init-plantabs */"./js/modules/init-plantabs.js"),o=s(/*! ./modules/init-swiper */"./js/modules/init-swiper.js");window.addEventListener("DOMContentLoaded",(function(){Object(n.iosVhFix)(),Object(i.initVideo)(),Object(r.initPlanTabs)(),Object(o.initSwiper)(),window.addEventListener("load",(function(){Object(a.initModals)()}))}))},"./js/modules/init-plantabs.js":
/*!*************************************!*\
  !*** ./js/modules/init-plantabs.js ***!
  \*************************************/
/*! exports provided: initPlanTabs */function(e,t,s){"use strict";function n(){var e=document.querySelector(".plans");if(e){var t=e.querySelector(".plans__nav"),s=null!==t&&t.querySelectorAll("a"),n=e.querySelectorAll(".plans__list"),a=0;if(!1!==s){var i=function(e){var t=s[e],i=s[a];t.focus(),t.removeAttribute("tabindex"),t.setAttribute("aria-selected","true"),i.removeAttribute("aria-selected"),i.setAttribute("tabindex","-1"),n[a].hidden=!0,n[e].hidden=!1,a=e};s.forEach((function(e,t){e.addEventListener("click",(function(e){return e.preventDefault(),a===t?n[a].focus():i(t)})),e.addEventListener("keydown",(function(e){switch(e.key){case"ArrowRight":return a!==s.length-1&&i(a+1);case"ArrowLeft":return 0!==a&&i(a-1);case"ArrowDown":return n[a].focus()}}))}))}}}s.r(t),s.d(t,"initPlanTabs",(function(){return n}))},"./js/modules/init-swiper.js":
/*!***********************************!*\
  !*** ./js/modules/init-swiper.js ***!
  \***********************************/
/*! exports provided: initSwiper */function(e,t,s){"use strict";s.r(t),s.d(t,"initSwiper",(function(){return a}));var n=s(/*! swiper */"../node_modules/swiper/swiper.esm.js");function a(){new n.default(".main-review__wrapper",{direction:"horizontal",spaceBetween:405,grabCursor:!0,loop:!0,modules:[n.Navigation,n.A11y],navigation:{nextEl:".main-review__next",prevEl:".main-review__prev"}}),new n.default(".main-coaches__wrapper",{direction:"horizontal",updateOnWindowResize:!0,spaceBetween:300,grabCursor:!0,loop:!0,modules:[n.Navigation,n.A11y],breakpoints:{768:{slidesPerView:2,spaceBetween:30},1200:{slidesPerView:4,spaceBetween:40}},navigation:{nextEl:".main-coaches__next",prevEl:".main-coaches__prev"}})}},"./js/modules/init-video.js":
/*!**********************************!*\
  !*** ./js/modules/init-video.js ***!
  \**********************************/
/*! exports provided: initVideo */function(e,t,s){"use strict";function n(){var e=document.querySelector(".video"),t=e.querySelector(".video__button"),s=e.querySelector(".video__link"),n=s.href.slice(17);s.removeAttribute("href"),t.hidden=!1,e.addEventListener("click",(function(){var t=e.parentElement,s=document.createElement("iframe");s.setAttribute("allowfullscreen",""),s.setAttribute("allow","autoplay"),s.setAttribute("src","https://www.youtube.com/embed/".concat(n,"?rel=0&showinfo=0&autoplay=1")),s.classList.value=e.classList.value,s.width=364,s.height=228,t.replaceChild(s,e)}))}s.r(t),s.d(t,"initVideo",(function(){return n}))},"./js/modules/modals/init-modals.js":
/*!******************************************!*\
