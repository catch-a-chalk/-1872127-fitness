...
/* harmony import */ var _modules_init_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-video */ "./js/modules/init-video.js");
/* harmony import */ var _modules_init_plantabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-plantabs */ "./js/modules/init-plantabs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_video__WEBPACK_IMPORTED_MODULE_2__["initVideo"])();
  Object(_modules_init_plantabs__WEBPACK_IMPORTED_MODULE_3__["initPlanTabs"])();
  Object(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_4__["initSwiper"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
/*!*************************************!*\
  !*** ./js/modules/init-plantabs.js ***!
  \*************************************/
/*! exports provided: initPlanTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPlanTabs", function() { return initPlanTabs; });
function initPlanTabs() {
  var plansSection = document.querySelector(".plans");

  if (plansSection) {
    var navigation = plansSection.querySelector(".plans__nav"),
    ...
    if (tabs !== false) {
      ...
      tabs.forEach(function (tab, index) {
        ...
        tab.addEventListener("keydown", function (_ref) {
          var key = _ref.key;

          switch (key) {
            case "ArrowRight":
              return currentTabIndex !== tabs.length - 1 && switchTab(currentTabIndex + 1);
...
function initSwiper() {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".main-review__wrapper", {
    direction: "horizontal",
    spaceBetween: 405,
    grabCursor: true,
    loop: true,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".main-coaches__wrapper", {
    direction: "horizontal",
    updateOnWindowResize: true,
    spaceBetween: 300,
    grabCursor: true,
...
function initVideo() {
  ...
  var button = wrapper.querySelector(".video__button");
  var video = wrapper.querySelector(".video__link");
  var youtubeID = video.href.slice(17);
  ...
  wrapper.addEventListener("click", function () {
    ...
    iframe.setAttribute("src", "https://www.youtube.com/embed/".concat(youtubeID, "?rel=0&showinfo=0&autoplay=1"));
